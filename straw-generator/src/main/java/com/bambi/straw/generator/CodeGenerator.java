...
public class CodeGenerator {
    ...
    public static String password="Reindeer";
    //父级别包名称
    public static String parentPackage = "com.bambi.straw";
    //代码生成的目标路径
    ...
    public static String baseControllerClassName ;// = "com.bambi.straw.portal.base.BaseController";
    //业务层的公共基类，用于抽象公共方法
    public static String baseServiceClassName ;   // = "com.bambi.straw.portal.base.BaseServiceImpl";
    //作者名
    public static String author = "MR.Bambi";
    //模块名称，用于组成包名
